...
- **Released**: `v0.1.0a7` (2026-05-13) — [GitHub Release](https://github.com/sillok-os/sillok/releases/tag/v0.1.0a7) · [PyPI](https://pypi.org/project/sillok/0.1.0a7/)
...
- Current count: **15 packs** across 4 sub-categories (`methodology`, `consulting`, `business`/`visual`, `core`)
- Wave 1a (`0.1.0a7`): +5 packs — `meeting-minutes`, `change-management`, `tool-adoption-consulting`, `project-charter`, `infographic-design`
- Wave 1b (`0.2.0a2`, planned): +5 — `consulting-uxui-audit`, `consulting-ai-engineering-audit`, `consulting-security-audit`, `consulting-growth-audit`, `consulting-crossanalysis`

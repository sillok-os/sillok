"""Smoke tests for sillok.jikji — placeholder until the module ships.

The jikji module is scheduled for Phase 1 (see roadmap §1 / docs/modules/).
...
def test_() -> None:
    ...
    mod = importlib.import_module("sillok.jikji")

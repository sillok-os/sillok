"""Smoke tests for sillok.sangso — placeholder until the module ships.

The sangso module is scheduled for Phase 1 (see roadmap §1 / docs/modules/).
...
def test_() -> None:
    ...
    mod = importlib.import_module("sillok.sangso")
